...
leftSum[i] = 0. rightSum[i] is the sum of elements to the right of the index i in the array nums. If there is 
no such element, rightSum[i] = 0. Return an integer array answer of size n where 
...
class Leetcode2574{
    ...
    public static void main(String[]args){
        ...
        int[] ar = leftRightDifference(arr);
